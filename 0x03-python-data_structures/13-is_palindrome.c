...
/**
 * reverse - program that reverses the second half of the list
 *
...
/**
 * compare - program that compares each int of the list
 *
...
/**
 * is_palindrome - program that checks if a singly linked list
 * is a palindrome
